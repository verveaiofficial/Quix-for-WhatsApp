...
// Serve live, auto-refreshing QR Code webpage
    ...
    sock.ev.on('connection.update', (update) => {
        ...
        if (connection === 'close') {
            ...
            if (shouldReconnect) {
                ...
                console.log('Logged out. Clear auth_info_baileys folder to relink.');
            }
            ...
            return res.send(`
                ...
                <body>
                    <div class="card">
                        ...
                        <p>WhatsApp > Linked Devices > Link a Device</p>
                        <img src="${qrImage}" alt="WhatsApp QR Code" />
                        <p style="margin-top: 15px;">Auto-refreshing to keep code fresh...</p>
                    </div>
                </body>
                </html>
            `);
